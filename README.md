...
- **Dedicated server** - magnets are always on. Clients do not strictly need the mod for magnets to be craftable and work, but without it, they will see the plain fireball texture instead of the magnet.
